	...
	return (
		<div className="docContainer">
			...
			<p>
				...
				in the Getting Started chapter. The options object accepts the following
			...
			<ul>
				...
				<li>
					<strong>maxQueryDepth</strong> - (optional, default:{' '}
					<code className="obsidianInline">0</code>) If set to integer of 1 or
					more, returns error in response to request object with nesting depth
					greater than the maxQueryDepth and does not route request to GraphQL

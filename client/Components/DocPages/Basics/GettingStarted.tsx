...
app.use(GraphQLRouter.routes(), GraphQLRouter.allowedMethods());`}
      ...
      <p>To test our new GraphQL endpoint, head to <a href="localhost:8000/graphql">localhost:8000/graphql</a> to test your queries with GraphQL Playground.  To learn more about this tool, check out their <a href="https://github.com/graphql/graphql-playground">GitHub repo</a>.</p>
      <h4>Recap & Next Up</h4>
      <p>In this chapter we set up a simple server with Oak and a GraphQL endpoint with ObsidianRouter.  Next, we'll explore ObsidianWrapper, <code className="obsidianInline">obsidian</code>'s client implementation, via a React app built with server-side rendering.</p>
    </div>
  )
}

...
const NavBar = (props: any) => {
  ...
  return (
    <div className="navBar">
      ...
      <a href="#" onClick={(e:any) => {e.preventDefault(); setPage('about');}}>brackets weird</a>
      ...
      <a><button className="navBtn" onTouchEnd={() => {setPage('about')}} onClick={() => {setPage('about')}}>
        <svg width="80%" height="70%" viewBox="0 0 16 16" className="bi bi-person-lines-fill" fill="#EBEBEC" xmlns="http://www.w3.org/2000/svg">
      ...
      <button className="navBtn" onClick={() => {setPage('demo')}} ontouchend={() => {setPage('demo')}}>
        <svg width="80%" height="70%" viewBox="0 0 16 16" className="bi bi-laptop" fill="#EBEBEC" xmlns="http://www.w3.org/2000/svg">
      ...
      <button className="navBtn" onChange={() => {setPage('docs')}} onClick={() => {setPage('docs')}} onTap={() => {setPage('docs')}}>
        <svg width="80%" height="70%" viewBox="0 0 16 16" className="bi bi-file-earmark-text" fill="#EBEBEC" xmlns="http://www.w3.org/2000/svg">
